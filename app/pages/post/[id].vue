<template>
    ...
    >
        <div class="lg:w-[calc(100%-540px)] h-full relative">
            <NuxtLink
                class="absolute z-20 m-5 rounded-full bg-white/20 backdrop-blur-sm p-1.5 hover:bg-white/30 transition-colors flex items-center justify-center"
            >
                <Icon class="text-white" name="material-symbols:close" size="27"/>
            </NuxtLink>
            ...
            <div v-if="true">
                <button 
                    ...
                    class="absolute z-20 right-4 top-4 flex items-center justify-center rounded-full bg-white/20 backdrop-blur-sm p-1.5 hover:bg-white/30 transition-colors"
                >
                    <Icon class="text-white" name="mdi:chevron-up" size="30"/>
                </button>

                <button 
                    :disabled="!isLoaded"
                    @click="loopThroughPostsDown()" 
                    class="absolute z-20 right-4 top-20 flex items-center justify-center rounded-full bg-white/20 backdrop-blur-sm p-1.5 hover:bg-white/30 transition-colors"
                >
                    <Icon class="text-white" name="mdi:chevron-down" size="30"/>
                </button>
            </div>
        ...
        >
            ...
            <div class="flex items-center px-8 mt-8">
                ...
                <div class="pb-4 text-center flex items-center">
                    <div class="rounded-full bg-gray-200 p-2 cursor-pointer flex items-center justify-center">
