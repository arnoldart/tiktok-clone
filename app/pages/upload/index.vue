    ...
    <UploadLayout>
        <div class="w-full mt-[80px] mb-[40px] bg-white shadow-lg rounded-md py-6 md:px-10 px-4 ">
            ...
            <div class="mt-8 md:flex gap-6">
                <label v-if="!fileDisplay" for="fileInput" @drop.prevent="onDrop" @dragover.prevents=""
                    ...
                    <Icon class="#B3B3B1" name="majesticons:cloud-upload" size="40" />
                ...
                <div v-else
                    ...
                    <img class="absolute z-20 pointer-events-none" alt="" src="../../assets/images/mobile-case.png">
                    <img class="absolute right-4 bottom-6 z-20" width="90"
                    ...
                    <div
                        class="absolute -bottom-12 flex items-center justify-between z-50 rounded-xl border border-gray-300 w-full p-2 ">
                        ...
                        <button @click="$event => clearVideo()" class="text-[12px] ml-2 font-semibold">
                            Change
                        </button>
                    </div>
                </div>
                <div class="mt-4 mb-6">
                    ...
                    <div class="mt-5">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="text-gray-[400] text-[12px] text-wrap">{{ caption.length }}/150</div>
                        </div>
                        {{ caption }}
                        <input v-model="caption" maxlength="150" type="text"
                            class="w-full border border-gray-300 p-2.5 rounded-md focus:outline-none">
                    </div>
                    <div class="flex gap-3">
                        <button @click="discard"
                            class="px-10 py-2.5 mt-8 border text-[16px] border-gray-300 hover:bg-gray-100 rounded-sm">
                            Discard
                        </button>
                        <button
                            class="px-10 py-2.5 mt-8 border text-[16px] border-gray-300 bg-[#F02C56] text-white rounded-sm">
                            Post
                        </button>
                    </div>
                </div>
