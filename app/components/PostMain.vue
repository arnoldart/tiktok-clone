<template>
    <div id="PostMain" class="flex border-b border-gray-300 py-6 ">
        ...
        <div class="pl-3 w-full px-4">
            ...
            <div class="mt-2.5 flex">
                <div
                    ...
                    <video ref="video" loop muted class="rounded-xl object-cover mx-auto h-full" src="/sample.mp4">
                    </video>
                    <img class="absolute right-2 bottom-14" src="../assets/images/tiktok-logo-white.png" width="90"
                        alt="">
                </div>
