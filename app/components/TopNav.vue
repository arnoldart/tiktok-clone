<template>
    <div id="TopNav" class="fixed bg-white z-30 flex items-center w-full border-b border-gray-300 h-[61px]">
        <div :class="route.fullPath === '/' ? 'max-w-[1150px]' : ''"
            ...
            <div :class="route.fullPath === '/' ? 'w-[80%]' : 'lg:w-[20%] w-[70%]'">
                <NuxtLink to="/">
                    <img width="115" src="../assets/images/tiktok-logo.png" alt="ini link">
                </NuxtLink>
            </div>
            ...
            <div class="flex items-center justify-end gap-3 min-w-[275px] max-w-[320px] w-full">
                <button class="flex items-center border border-gray-300 rounded-sm px-3 py-[6px] hover:bg-gray-100">
                ...
                <div class="flex items-center">
                    ...
                    <div class="relative">
                        ...
                        <div
                            v-if="showMenu"
                            id="PopupMenu"
                            class="absolute bg-white rounded-lg py-1.5 w-[200px] shadow-xl border border-gray-300 top-[43px] -right-2"
                        >
                            <NuxtLink
                            ...
                            >
                             ...
                             <NuxtLink
                                @click="$event => showMenu = false"
                                class="flex items-center justify-start py-3 px-1.5 hover:bg-gray-100 border-gray-300 border-t cursor-pointer"
                            >
